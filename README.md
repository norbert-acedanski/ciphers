...
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/norbert-acedanski/ciphers/tests?label=tests)
...
Currently, there should be **306 tests passed**.  
